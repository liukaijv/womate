                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row m-t-sm">
                            <div class="col-lg-2">
                                {!! Form::open(['url'=>route('post_catalog.index'), 'method'=>'GET']) !!}
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <a class="btn btn-white" href="{{route('post_catalog.create')}}">新增分类</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table">
                            ...
                            @foreach($catalogs as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a data-modal="form"
                                           href="{{route('post_catalog.edit',$item)}}"
                                           class="btn btn-primary btn-xs">编辑</a>
                                        @if($item->system_default==0)
                                            {!! Form::open(['url'=>route('post_catalog.destroy',[$item]),'method'=>'DELETE', 'style'=>'display: inline-block;']) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                @include('backend.partials.bulk', ['bulkActionUrl'=>route('post_catalog.bulk')])
                            </div>
                            <div class="col-lg-10">
